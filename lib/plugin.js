...
function HistoryPlugin (schema, options = {}) {
  ...
  schema.pre(
    /update|updateOne|findOneAndUpdate|findByIdAndUpdate|updateMany|findOneAndReplace|replaceOne/,
    async function () {
      await initializeProcess.call(
        getCurrentUser.call(this, schema),
        _processPreUpdate,
...
async function _processRemoveMany (options) {
  ...
  Promise.map(
    olds,
    async (eachOld) => await _processPosRemove.call(this, options, eachOld)
  )
}
...
async function _processPosInsertMany (options, docs) {
  return Promise.map(
    docs,
    async (eachDoc) => await _processPosSave.call(this, options, eachDoc)
  )
}
